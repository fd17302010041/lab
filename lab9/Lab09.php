...
<body>
    ...
    <main class="container">
        ...
        <?php
        $imgArr = array(22,54,7,19,46,6,60,58,75,77,27,2,24,13,101,102);
        for ($j = 0;$j <16; $j ++){
            $country = $images[$imgArr[$j]];
            echo "<ul class='caption-style-2'>
                        <li>
                            <a href='detail.php?id=$country[id]' class='img-responsive'>
                                <img src='images/square/$country[path]' alt='$country[title]'>
                                <div class='caption'>
                                    <div class='blur'>
                                    </div>
                                    <div class='caption-text'><h1>$country[title]</h1>
                                    </div>
                                </div>
                            </a>
                        </li>
